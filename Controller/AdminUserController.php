...
use Fulgurio\LightCMSUserBundle\Entity\User;
use Fulgurio\LightCMSUserBundle\Form\Handler\AdminUserHandler;
use Fulgurio\LightCMSUserBundle\Form\Type\AdminUserType;
...
class AdminUserController extends Controller
{
    ...
    public function listAction()
    {
        ...
        $usersNb = $this->getDoctrine()->getRepository('FulgurioLightCMSUserBundle:User')->count($filters);
        $users = $this->getDoctrine()->getRepository('FulgurioLightCMSUserBundle:User')->findAllWithPagination($filters, $nbPerPage, $page * $nbPerPage);
        return $this->render('FulgurioLightCMSUserBundle:AdminUser:list.html.twig', array(
                'users' => $users,
                'nbUsers' => $usersNb,
    ...
    private function createUser(User $user)
    {
        ...
        return $this->render('FulgurioLightCMSUserBundle:AdminUser:add.html.twig', $options);
    }
    ...
    private function checkConfiguration()
    {
        ...
        if (get_class($currentUser) !== 'Fulgurio\LightCMSUserBundle\Entity\User')
        {
     ...
     *
     * @param number $userId
     * @return Fulgurio\LightCMSUserBundle\Entity\User
     * @throws NotFoundHttpException
     */
    private function getSpecifiedUser($userId)
    {
        if (!$user = $this->getDoctrine()->getRepository('FulgurioLightCMSUserBundle:User')->findOneBy(array('id' => $userId)))
        {
